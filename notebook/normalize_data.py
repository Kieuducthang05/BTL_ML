...
# --- CẤU HÌNH ĐƯỜNG DẪN ---
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))  # Thư mục gốc chứa data tải về
TRACKING_DIR = os.path.join(BASE_DIR, 'train_tracking')
META_PATH = os.path.join(BASE_DIR, 'train.csv')
OUTPUT_DIR = os.path.join(BASE_DIR, 'processed_data_normalized') # Thư mục lưu kết quả
